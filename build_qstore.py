...
TXT = [
    ...
    ("Portfolio demo — Maison Cacao is a fictional business. Payments are simulated; the live build runs on Stripe or PayPal. A store like this, with payment gateway and 40 products loaded: $700, delivered in 14 days.",
    ...
    ("<title>Product — Maison Cacao</title>", "<title>Product — Bait Al Cacao</title>"),
]
...
j = j.replace("Maison Cacao", "Bait Al Cacao").replace("MC-'+new Date()", "BC-'+new Date()")
